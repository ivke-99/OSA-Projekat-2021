...
const SignUpFormSalesman: React.FC = () => {
    ...
    const sendToAPI = (form: SignUpFormInputsSalesman) => {
        axios
            .post("/register-salesman", form)
            .then((res) => {
    ...
    return (
        <>
            ...
            <VStack borderWidth="1px" borderRadius="lg" overflow="hidden" mt={4} width="full" p={5} spacing={8}>
                ...
                <FormControl isInvalid={!!errors?.email?.message} errortext={errors?.email?.message} isRequired>
                    <FormLabel color={primaryColor}>E-mail</FormLabel>
                    <Input type="email" placeholder="Input your E-mail" {...register("email")} />
                ...
                <FormControl
                    ...
                    isRequired
                >
                    <FormLabel color={primaryColor}>Company name</FormLabel>
                    <Input type="text" placeholder="Input the name of your company" {...register("companyName")} />
...
export default SignUpFormSalesman;
